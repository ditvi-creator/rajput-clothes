      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed top-0 right-0 z-[70] h-full w-full max-w-md bg-brand-white text-brand-onyx p-8 flex flex-col"
          >
            ...
            <div className="flex-1 overflow-y-auto no-scrollbar py-4">
              {cart.length > 0 ? (
                ...
                <div className="h-full flex flex-col items-center justify-center text-center">
                  ...
                  <button 
                    onClick={onClose}
                    className="px-8 py-4 bg-brand-onyx text-brand-white text-[10px] tracking-[0.3em] uppercase font-bold hover:bg-brand-gold transition-colors flex items-center gap-2"
                  >
