...
export default function Footer() {
  return (
    <footer className="py-24 bg-black border-t border-white/5 text-brand-white">
      <div className="container mx-auto px-4 sm:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-16 lg:gap-8">
          {/* Column 1: The Brand */}
          <div className="flex flex-col gap-8 text-center sm:text-left">
            <h2 className="text-3xl font-serif tracking-tighter uppercase">
               Rajput <span className="text-brand-gold">Clothes</span>
            </h2>
            <p className="text-xs text-brand-white/40 leading-relaxed max-w-[280px] mx-auto sm:mx-0">
            ...
            <div className="flex items-center justify-center sm:justify-start gap-6">
              {[Instagram, MessageCircle, Youtube, Pinterest].map((Icon, idx) => (
                <a key={idx} href="#" className="text-brand-white/40 hover:text-brand-gold transition-all duration-300 transform hover:scale-110">
          ...
          <div className="flex flex-col gap-6 text-center sm:text-left">
            ...
            <div className="flex flex-col gap-4 text-xs tracking-widest text-brand-white/60">
        ...
        <div className="mt-24 pt-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-6 opacity-30">
...
function FooterLink({ children }: { children: React.ReactNode }) {
  return (
    <a href="#" className="hover:text-brand-white transition-colors duration-300">
      {children}
    </a>
  );
}
