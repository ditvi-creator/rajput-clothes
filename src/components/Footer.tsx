...
export default function Footer() {
  return (
    <footer className="py-24 bg-brand-onyx border-t border-brand-white/10 text-brand-white">
      <div className="container mx-auto px-4 sm:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-16 lg:gap-8">
          {/* Column 1: The Brand */}
          <div className="flex flex-col gap-8 text-center sm:text-left">
            <h2 className="text-3xl font-serif tracking-tighter uppercase text-brand-white">
               Rajput <span className="text-brand-gold">Clothes</span>
            </h2>
            <p className="text-xs text-brand-white/60 leading-relaxed max-w-[280px] mx-auto sm:mx-0">
        ...
        <div className="mt-24 pt-8 border-t border-brand-white/10 flex flex-col sm:flex-row items-center justify-between gap-6 opacity-60">
